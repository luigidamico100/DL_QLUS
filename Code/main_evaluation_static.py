...
from config import regularization, criterion, num_epochs, OUTFOLDER_PATH, info_text
import torch
...
if __name__ == '__main__':
    ...
    model_eval = torch.load("../Experiments/Experiments_1/model_last.pt", map_location=device)
