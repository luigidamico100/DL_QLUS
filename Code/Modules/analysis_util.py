...
def create_and_save_dataframe_train(out_path='../../Experiments/train_dataset.csv', target_value=False):
    '''
...
def create_and_save_dataframe_videos(dataframe_train, out_path='../../Experiments/video_dataset.csv'):
    '''
    ...
    '''
    dataframe_videos = dataframe_train.groupby(['bimbo_name', 'classe', 'video_name', 'processed_video_name'], as_index=False).sum()
